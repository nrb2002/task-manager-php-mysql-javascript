        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
          ...
          <form action="" method="post" class="row g-3 needs-validation" novalidate>
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="validationFirstname" value="<?php echo $_SESSION["firstname"];?>" required>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
            <div class="col-md-4">
              <label for="validationLastname" class="form-label">Family name</label>
              <input type="text" class="form-control" id="validationLastname" value="<?php echo $_SESSION["lastname"];?>" required>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
