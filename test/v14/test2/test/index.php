<html>
	<head>
		<title>Sharp Tutorial - Jump to a Specific Page with PHP Ajax (jQuery DataTable) </title>
	...
	<body>
		<div class="container">
			<br />
			<h3 align="center" class="text-danger"><b>Sharp Tutorial - Jump to a Another Page with PHP Ajax (jQuery DataTable) </b></h3>
			<br />
			<div class="card">
				<div class="card-header">
					<div class="row">
						<div class="col-md-9">Student Data</div>
						<div class="col-md-3">
